...
class BugActivity: AppCompatActivity() {
    ...
    private fun initViews() {
        ...
        val appBarConfiguration = AppBarConfiguration(
            topLevelDestinationIds = setOf(R.id.bugListFragment),
    ...
    private fun bindViews() {
        ...
        toolBarSearchIcon.setOnClickListener {
            ...
            navigationController.navigate(R.id.action_bugListFragment_to_bugSearchFragment)
        }
        ...
        navigationController.addOnDestinationChangedListener { _, destination, _ ->
            if (destination.id != R.id.bugListFragment) {
